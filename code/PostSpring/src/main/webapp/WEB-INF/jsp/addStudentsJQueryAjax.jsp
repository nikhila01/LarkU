		...
		if (allGood) {
			...
			$
					.ajax({
						...
						url : "http://localhost:8080/${pageContext.request.contextPath}/adminrest/students",
						type : "post",
						dataType : "json",
						data : newCourse,
	...
	$(document)
			.ready(
					function() {
						...
						var href = "http://localhost:8080/${pageContext.request.contextPath}/adminrest/heldstudents";
						$
								.get(
										href,
										function(values) {
