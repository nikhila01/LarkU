...
<body>
	...
	<form action="${pageContext.request.contextPath}/registration/v1/webapp/admin/registerStudentForClass" method="post" >
			...
			<tr>
				...
				<td><select name="classId">
						<c:forEach items="${classes}" var="sClass">
							<option value="${sClass.id}">${sClass.course.code} - ${sClass.startDate} - ${sClass.endDate}</option>
						</c:forEach>
				</select></td>
				</tr>
			<tr>
