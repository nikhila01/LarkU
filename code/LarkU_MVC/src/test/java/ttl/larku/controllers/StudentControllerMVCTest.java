...
public class StudentControllerMVCTest {
	...
	public void testGetStudent() throws Exception {
		...
		actions = actions.andExpect(view().name("/WEB-INF/jsp/showStudent.jsp"));
		actions = actions.andExpect(model().attribute("student", hasProperty("name", equalTo("Manoj"))));
	}
	...
	public void testStudentNotFoundGet() throws Exception {
		...
		actions = actions.andExpect(status().isOk());
		actions = actions.andExpect(view().name("/WEB-INF/jsp/error/studentNotFound.jsp"));
	}
	...
	public void testGetStudents() throws Exception {
		...
		actions = actions.andExpect(status().isOk());
		actions = actions.andExpect(view().name("/WEB-INF/jsp/showStudents.jsp"));
	...
	public void testShowAddForm() throws Exception {
		...
		actions = actions.andExpect(status().isOk());
		actions = actions.andExpect(view().name("/WEB-INF/jsp/addStudent.jsp"));
