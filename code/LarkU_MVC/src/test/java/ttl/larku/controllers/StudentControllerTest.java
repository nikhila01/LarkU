...
public class StudentControllerTest {
	...
	public void init() {
		...
		StudentService ss = appContext.getBean("studentService",
	...
	public void testGetStudent() {
		...
		assertEquals("/WEB-INF/jsp/showStudent.jsp", mav.getViewName());
	}
	...
	public void testStudentNotFoundGet() {
		...
		assertEquals("/WEB-INF/jsp/error/studentNotFound.jsp", mav.getViewName());
	}
	...
	public void testGetStudents() {
		...
		assertEquals("/WEB-INF/jsp/showStudents.jsp", mav.getViewName());
	...
	public void testShowAddForm() {
		...
		String result = studentController.showAddStudentForm((Student) binder.getTarget());

		assertEquals("/WEB-INF/jsp/addStudent.jsp", result);
	...
	public void testAddStudent() {
		...
		ModelAndView result = studentController.addStudent(
				(Student) binder.getTarget(), binder.getBindingResult());
	...
	public void testAddStudentWithErrors() {
		...
		ModelAndView result = studentController.addStudent(
				(Student) binder.getTarget(), errors);
	...
	public void testAddStudentWithSessionAttributes() {
		...
		ModelAndView result = studentController.addStudentWithSessionAttributes(
				(Student) binder.getTarget(), binder.getBindingResult(),
				sessionStatus, "Boo");
